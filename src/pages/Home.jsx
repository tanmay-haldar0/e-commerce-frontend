...
const Home = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="mt-2 px-5 w-full h-28 grid grid-cols-9">
        <CategoryCard
        ...
        />
        <CategoryCard
          ctImg={"https://media.istockphoto.com/id/649708848/photo/coffee.webp?a=1&b=1&s=612x612&w=0&k=20&c=hg90c0_Ef-IJ3CQ61b_4SIG5vxKA689zGhtTH-A9iwM="}
          ctName={"Cofee"}
        />
        <CategoryCard
      ...
      <div className="flex items-center h-full">
        <div className='grid px-10 mt-5 grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-6 gap-4'>
        ...
        <VBanner
          mClass={"mr-8"}
          tColor={"text-white"}
          bgImgUrl={"https://media.istockphoto.com/id/1255850905/photo/happy-diwali-diya-oil-lamps-on-colorful-rangoli-with-copy-space.webp?a=1&b=1&s=612x612&w=0&k=20&c=tkN__TcfJrMQSlHPblQ9Fwi8efN9jnMvP1uoZNPpzmM="} />
      </div>
      ...
      <div className="flex items-center justify-center h-full">
        <VBanner
          mClass={"ml-8"}
          tColor={"text-white"}
          bgImgUrl={"https://media.istockphoto.com/id/1735400533/photo/decorated-christmas-tree-with-balls.jpg?s=612x612&w=0&k=20&c=gfDJGJXD1Xeb_W3Tdvt1i3whCdEChta1SMm4Fj5IQQs="} />

        <div className="">
          <div className="mt-20 pl-10 px-2">
            <h1 className="text-2xl font-semibold">Popular Products</h1>
          </div>
          <div className='grid px-10 mt-5 grid-cols-1 md:grid-cols-4 ml lg:grid-cols-4 xl:grid-cols-6 gap-4'>
            <ProductCard imgSrc={"https://media.istockphoto.com/id/1252605699/photo/veg-momos-on-black-slate-table-top-momos-is-the-popular-dish-of-indian-tibetan-chinese.webp?a=1&b=1&s=612x612&w=0&k=20&c=qil7GGAkjXOSIu6NB19XIlqAy2CYf4U0arY0c5uy05M="}
              isSale={true}
              productName={"Veg Dumplings"}
              price={29.99}
