    ...
    return (
        <div className="relative border rounded-lg p-2 bg-white shadow-md hover:shadow-2xl transition-all ease-out border-slate-300">
            <div className="flex flex-col  justify-between">
                ...
                {isSale ? (<p className="sm:text-sm text-xs mt-1 text-red-500 font-semibold">Flat 50% off</p>):(<p className="sm:text-sm text-xs mt-1 text-slate-500 font-semibold">Value for Price</p>)}
                <div className="flex items-center mt-2">
                    <button className='btn w-full bg-primary hover:bg-blue-400 p-2 rounded-md text-white font-medium text-xs sm:text-sm'>Buy Now</button>
                </div>
